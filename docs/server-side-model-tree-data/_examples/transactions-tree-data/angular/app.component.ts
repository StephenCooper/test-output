...
@Component({
  ...
  template: `<div class="example-wrapper">
    <div style="margin-bottom: 5px">
      <button (click)="addToSelected()">Add Child to Selected</button>
      <button (click)="updateSelected()">Update Selected</button>
      <button (click)="deleteSelected()">Delete Selected</button>
      <button (click)="moveSelected()">Move Selected to Robert Peterson</button>
    </div>
    <ag-grid-angular
...
export class AppComponent {
  ...
  getRowId: GetRowIdFunc = (row: GetRowIdParams) => String(row.data.employeeId);
  isServerSideGroup: IsServerSideGroup = (dataItem: any) => dataItem.group;
