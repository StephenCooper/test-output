...
export class AppComponent {
  ...
  getRowId: GetRowIdFunc = (row) => String(row.data.employeeId);
  isServerSideGroup: IsServerSideGroup = (dataItem) => dataItem.group;
  getServerSideGroupKey: GetServerSideGroupKey = (dataItem) =>
