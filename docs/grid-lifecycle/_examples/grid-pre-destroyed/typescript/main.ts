...
const displayColumnsWidth = (values: ColumnWidth[]) => {
  const parentContainer = document.querySelector<HTMLElement>(
    "#gridPreDestroyedState",
  )!;
...
if (typeof window !== "undefined") {
  ...
  (<any>window).updateColumnWidth = updateColumnWidth;
  (<any>window).destroyGrid = destroyGrid;
