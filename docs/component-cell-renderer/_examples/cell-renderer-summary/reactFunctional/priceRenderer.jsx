...
export default (params) => {
    ...
    return (<span className="imgSpan">
            {priceArr.map((_, index) => (<img key={index} src="https://www.ag-grid.com/example-assets/icons/pound-coin-color-icon.svg" className="priceIcon"/>))}
        </span>);
};
